  ...
  return (
    <View style={styles.container}>
      <SafeAreaView style={styles.safeArea}>
        ...
        {error && (
          <TouchableOpacity style={styles.errorBanner} onPress={fetchSchedule}>
        ...
        <View style={styles.modalBackdrop}>
          <View style={styles.modalCard}>
            ...
            <View style={styles.modalActions}>
              <TouchableOpacity style={styles.secondaryButton} onPress={() => setNoteCell(null)}><Text style={styles.secondaryText}>Cancel</Text></TouchableOpacity>
              <TouchableOpacity style={styles.primaryButton} onPress={saveNotes}><Text style={styles.primaryText}>Save Note</Text></TouchableOpacity>
            </View>
          </View>
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  phaseRow: { width: TASK_WIDTH + CELL_WIDTH * 7, flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: SPACING.sm, height: 36, backgroundColor: '#10151c', borderBottomWidth: 1, borderBottomColor: COLORS.border },
